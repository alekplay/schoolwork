...
public class Minipedia {
    ...
    public static void main(String[] args) {
        ...
        BinaryTree L = new BinaryTree();                        // Using binarytree instead of dumb list!
    ...
    private static BinaryTree createTree(DatabaseIterator it) {
    ...
    private static void addArticle(Scanner s, BinaryTree D) {             // Using binarytree instead of dumblist!
        System.out.println();
    ...
    private static void removeArticle(Scanner s, BinaryTree D) {            // Using binarytree instead of dumblist!
        System.out.println();
    ...
    private static void titleSearch(Scanner s, BinaryTree D) {              // Using binarytree instead of dumblist!
        System.out.println();
    ...
    private static void articleContentSearch(Scanner s, BinaryTree D) {   // use tree instead of list!
        System.out.println();
    ...
    private static void titleContentSearch(Scanner s, BinaryTree D) { // use tree instead of list! 
        System.out.println();
